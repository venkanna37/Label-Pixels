...
if __name__ == '__main__':
    ...
    parser.add_argument("--pred_folder", type=str, help="Predicted images folder", default=None)
    parser.add_argument("--pred_format", type=str, help=" Predicted images format", default=None)
