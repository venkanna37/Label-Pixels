...
class DataGenerator(keras.utils.Sequence):
    ...
    def __init__(self, image_paths, label_paths, net_type, batch_size=32, n_classes=2, patch_size=128, shuffle=True, rs=255,
                 rs_label=1):
        'Initialization'
    ...
    def __data_generation(self, image_paths, label_paths, n_classes, rescale_value, rs_label, net_type):
        # Initialization
        X = []
        y = []
        # Generate data
